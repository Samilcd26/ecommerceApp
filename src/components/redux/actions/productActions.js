...
export function getProductSuccess(PRODUCT) {
    return { type: ActionsType.GET_PRODUCT_SUCCESS, payload: PRODUCT }
}

export function createProductSuccess(product) {
    return { type: ActionsType.CREATE_PRODUCT_SUCCESS, payload: product }
}

export function updateProductSuccess(product) {
    return { type: ActionsType.UPDATE_PRODUCT_SUCCESS, payload: product }
}
...
export function handleError(error){
    console.error("Api hatası oluştu")
    throw error
}
